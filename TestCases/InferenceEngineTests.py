...
def revision():
    """
        ...
        :- (S-->P). %1.0;0.81%
    """
    j1 = NALGrammar.Sentence.Sentence.new_sentence_from_string("(S-->P). %1.0;0.9%")
    j2 = NALGrammar.Sentence.Sentence.new_sentence_from_string("(S-->P). %1.0;0.9%")
...
def first_order_deduction():
    """
        ...
        :- (S-->P). %1.0;0.81%
    """
    j1 = NALGrammar.Sentence.Sentence.new_sentence_from_string("(M-->P). %1.0;0.9%")
    j2 = NALGrammar.Sentence.Sentence.new_sentence_from_string("(S-->M). %1.0;0.9%")
...
def first_order_induction():
    """
        ...
        :- (P-->S). %1.0;0.45%
    """
    j1 = NALGrammar.Sentence.Sentence.new_sentence_from_string("(M-->S). %1.0;0.9%")
    j2 = NALGrammar.Sentence.Sentence.new_sentence_from_string("(M-->P). %1.0;0.9%")
...
def first_order_abduction():
    """
        ...
        :- (P-->S). %1.0;0.45%
    """
    j1 = NALGrammar.Sentence.Sentence.new_sentence_from_string("(S-->M). %1.0;0.9%")
    j2 = NALGrammar.Sentence.Sentence.new_sentence_from_string("(P-->M). %1.0;0.9%")
...
def first_order_analogy():
    ...
    """
    j1 = NALGrammar.Sentence.Sentence.new_sentence_from_string("(chimp-->monkey). %1.0;0.9%")
    j2 = NALGrammar.Sentence.Sentence.new_sentence_from_string("(human<->monkey). %1.0;0.9%")
...
def conditional_analogy():
    """
        ...
        :- P %1.0;0.81%
    """
    j1 = NALGrammar.Sentence.Sentence.new_sentence_from_string("(a-->b). %1.0;0.9%")
    j2 = NALGrammar.Sentence.Sentence.new_sentence_from_string("((a-->b)<=>(c-->d)). %1.0;0.9%")
...
def conditional_deduction():
    """
        ...
        :- P %1.0;0.81%
    """
    j1 = NALGrammar.Sentence.Sentence.new_sentence_from_string("((a-->b)==>(c-->d)). %1.0;0.9%")
    j2 = NALGrammar.Sentence.Sentence.new_sentence_from_string("(a-->b). %1.0;0.9%")
...
def conditional_abduction():
    ...
    """
    j1 = NALGrammar.Sentence.Sentence.new_sentence_from_string("((a-->b)==>(c-->d)). %1.0;0.9%")
    j2 = NALGrammar.Sentence.Sentence.new_sentence_from_string("(c-->d). %1.0;0.9%")
...
def conditional_conjunctional_deduction():
    ...
    j1 = NALGrammar.Sentence.Sentence.new_sentence_from_string("((&&,(a-->b),(c-->d))==>(e-->f)). %1.0;0.9%")
    j2 = NALGrammar.Sentence.Sentence.new_sentence_from_string("(c-->d). %1.0;0.9%")
    output_q = run_test(j1, j2)
...
def conditional_conjunctional_abduction():
    ...
    """
    j1 = NALGrammar.Sentence.Sentence.new_sentence_from_string("((&&,(a-->b),(c-->d))==>(e-->f)). %1.0;0.9%")
    j2 = NALGrammar.Sentence.Sentence.new_sentence_from_string("((c-->d)==>(e-->f)). %1.0;0.9%")
    output_q = run_test(j1, j2)
