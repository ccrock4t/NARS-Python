    ...
    def __init__(self, dimensions, truth_values = None, occurrence_time=None):
        ...
        def index_function(*coord_vars, self_obj=None):
            ...
            if isinstance(self_obj, NALGrammar.Terms.StatementTerm):
                ...
                predicate_is_array = isinstance(self_obj.get_predicate_term(), NALGrammar.Terms.CompoundTerm) and isinstance(
                ...
                if subject_is_array and predicate_is_array:
                    ...
                    element = NALGrammar.Terms.StatementTerm(subject_term=NALGrammar.Terms.CompoundTerm(subterms=[subject_atomic_element],
                    ...
                    element = NALGrammar.Terms.StatementTerm(subject_term=NALGrammar.Terms.CompoundTerm(subterms=[atomic_element],
                                                                                                        term_connector=NALSyntax.TermConnector.ExtensionalSetStart),
                    ...
                    element = NALGrammar.Terms.StatementTerm(subject_term=self_obj.get_subject_term(),
                                                             predicate_term=NALGrammar.Terms.CompoundTerm(subterms=[atomic_element],
                                                                                                          term_connector=NALSyntax.TermConnector.ExtensionalSetStart),
                                                             copula=self_obj.get_copula())
